...
async function main() {
  ...
  // We will programatically create a new account in order to interact with
  ...
  console.log(
    `✉️ The transfer transaction from my account with id ${myAccountId} to the new account with id ${newAccountId} was: ` +
